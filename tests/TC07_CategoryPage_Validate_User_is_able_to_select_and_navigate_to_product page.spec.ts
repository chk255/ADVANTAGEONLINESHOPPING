...
test.describe("Category Page Select Product Validation", async()=>{
     test("Validate Select Product Functionality" , async()=>{
          ...
          productPage= await categoryPage.SelectProduct(productName);
           ...
           await test.step("Validating User navigated to Product Page", async()=>{
